...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<script type="text/javascript">
				$("#9").attr("data-options", "plain:true,iconCls:'icon-edit',selected:true");
				$("#e").attr("data-options","selected:true");
			</script>
			<%@include file="../inc/purchase/purchase_field.inc"%>
			<%@include file="../inc/purchase/purchase_toolbar.inc"%>
			<%@include file="../inc/purchase/purchase_dialog.inc"%>
		</div>
	</div>
	<%-- 自定义脚本 --%>
	<script type="text/javascript"
