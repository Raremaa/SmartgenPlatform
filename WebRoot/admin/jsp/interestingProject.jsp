...
<%-- 自定义样式 --%>
<link rel="stylesheet" type="text/css" href="/SmartgenPlatform/admin/css/adminStyle.css">
<%--页面加载动画样式--%>
<link rel="stylesheet" type="text/css"
...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<script type="text/javascript">
				$("#5").attr("data-options", "plain:true,iconCls:'icon-edit',selected:true");
				$("#b").attr("data-options","selected:true");
			</script>
			<%@include file="../inc/interestingProject/interestingProject_field.inc"%>
			<%@include file="../inc/interestingProject/interestingProject_toolbar.inc"%>
			<%@include file="../inc/interestingProject/interestingProject_dialog.inc"%>
		</div>
		<!--/公有模版外内容-->
	...
	<%-- 自定义脚本 --%>
	<script type="text/javascript"
		src="/SmartgenPlatform/admin/js/interestingProject.js"></script>
</body>
</html>
