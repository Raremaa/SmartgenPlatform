...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<script type="text/javascript">
				$("#1").attr("data-options", "plain:true,iconCls:'icon-edit',selected:'true'");
				$("#a").attr("data-options","selected:true");
			</script>
			<%@include file="../inc/user/user_field.inc"%>
			<%@include file="../inc/user/user_toolbar.inc"%>
			<%@include file="../inc/user/user_dialog.inc"%>
		</div>
		<!--/公有模版外内容-->
	...
	<%-- 自定义脚本 --%>
	<script type="text/javascript"
		src="/SmartgenPlatform/admin/js/user.js"></script>
</body>
</html>
