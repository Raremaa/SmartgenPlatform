...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<script type="text/javascript">
				$("#4").attr("data-options", "plain:true,iconCls:'icon-edit',selected:true");
				$("#b").attr("data-options","selected:true");
			</script>
			<%@include file="../inc/creativeProject/creativeProject_field.inc"%>
			<%@include file="../inc/creativeProject/creativeProject_toolbar.inc"%>
			<%@include file="../inc/creativeProject/creativeProject_dialog.inc"%>
		</div>
		<!--/公有模版外内容-->
	...
	<%-- 自定义脚本 --%>
	<script type="text/javascript"
		src="/SmartgenPlatform/admin/js/creativeProject.js"></script>
</body>
</html>
