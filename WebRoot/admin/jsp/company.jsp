...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<script type="text/javascript">
				$("#2").attr("data-options", "plain:true,iconCls:'icon-edit',selected:'true'");
				$("#a").attr("data-options","selected:true");
			</script>
			<%@include file="../inc/company/company_field.inc"%>
			<%@include file="../inc/company/company_toolbar.inc"%>
			<%@include file="../inc/company/company_dialog.inc"%>
		</div>
		<!--/公有模版外内容-->
	...
	<%-- 自定义脚本 --%>
	<script type="text/javascript"
		src="/SmartgenPlatform/admin/js/company.js"></script>
</body>
</html>
