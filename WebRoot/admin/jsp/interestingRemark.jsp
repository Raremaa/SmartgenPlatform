...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<script type="text/javascript">
				$("#7").attr("data-options", "plain:true,iconCls:'icon-edit',selected:true");
				$("#c").attr("data-options","selected:true");
			</script>
			<%@include file="../inc/interestingRemark/interestingRemark_field.inc"%>
			<%@include file="../inc/interestingRemark/interestingRemark_toolbar.inc"%>
			<%@include file="../inc/interestingRemark/interestingRemark_dialog.inc"%>
		</div>
		<!--/公有模版外内容-->
