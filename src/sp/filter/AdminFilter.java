...
public class AdminFilter implements Filter {
	...
	public void doFilter(ServletRequest arg0, ServletResponse arg1, FilterChain arg2)
		...
		String userNameAdmin = (String) request.getSession().getAttribute("userNameAdmin");
		...
		if (null != userNameAdmin) {
			arg2.doFilter(arg0, arg1);
		} else {
			response.sendRedirect(request.getContextPath() + "/admin_login/login.jsp");
		}
	}
