...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<script type="text/javascript">
				$("#3").attr("data-options", "plain:true,iconCls:'icon-edit',selected:'true'");
				$("#a").attr("data-options","selected:true");
			</script>
			<%@include file="../inc/expert/expert_field.inc"%>
			<%@include file="../inc/expert/expert_toolbar.inc"%>
			<%@include file="../inc/expert/expert_dialog.inc"%>
		</div>
		<!--/公有模版外内容-->
	...
	<%-- 自定义脚本 --%>
	<script type="text/javascript"
		src="/SmartgenPlatform/admin/js/expert.js"></script>
</body>
</html>
