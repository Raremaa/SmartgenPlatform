...
<body>
	...
	<div class="easyui-layout" data-options="fit:true">
		...
		<div data-options="region:'center'">
			<script type="text/javascript">
				$("#8").attr("data-options", "plain:true,iconCls:'icon-edit',selected:true");
				$("#d").attr("data-options","selected:true");
			</script>
			<%@include file="../inc/product/product_field.inc"%>
			<%@include file="../inc/product/product_toolbar.inc"%>
			<%@include file="../inc/product/product_dialog.inc"%>
		</div>
		<!--/公有模版外内容-->
