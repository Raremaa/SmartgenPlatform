	...
	<div class="layui-layout layui-layout-admin ">
		...
		<div class="layui-body">
			...
			<div style="padding: 15px;">
				<%@include file="/expert/inc/projectTbale.inc"%>
			</div>
		</div>
